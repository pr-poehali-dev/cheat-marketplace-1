  ...
  const faqs = [
    {
      ...
      answer: 'Баны могут варьироваться от 6, 12 или 24 часов до 4 дней в зависимости от настроек и активности. Мы предоставляем рекомендации по безопасному использованию в приватном чате.'
    },
    {
